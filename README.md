# Project 9 - Front-end Dashboard (back)
...
- `http://localhost:5000/user/12/performance` - Retrieves the performance of the user with id 12
- `http://localhost:5000/user/18` - Retrieves user 18's main information.
